...
namespace TicTacToe.Data.EF.Migrations
{
    ...
    [Migration("20210430121701_AddRelationComputerPlayerInGame")]
    partial class AddRelationComputerPlayerInGame
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicTacToe.Models.Entity.Level", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TicTacToe.Models.Entity.Game", b =>
                {
                    b.HasOne("TicTacToe.Models.Entity.Player", "ComputerPlayer")
                        .WithMany("ComputerGames")
                        .HasForeignKey("ComputerPlayerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TicTacToe.Models.Entity.Level", "Level")
                        .WithMany("Games")
